...
export const ResultsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        /**
         * 
         * @summary Получить лучшие результаты тестирования
         * @param {ResultsBestGetByEnum} by 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        resultsBestGet: async (by: ResultsBestGetByEnum, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'by' is not null or undefined
            assertParamExists('resultsBestGet', 'by', by)
            const localVarPath = `/results/best`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
...
export const ResultsApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async resultsBestGet(by: ResultsBestGetByEnum, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<UserResults>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.resultsBestGet(by, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['ResultsApi.resultsBestGet']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 
...
export const ResultsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        resultsBestGet(by: ResultsBestGetByEnum, options?: RawAxiosRequestConfig): AxiosPromise<UserResults> {
            return localVarFp.resultsBestGet(by, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary Получить результаты пользователя
...
export class ResultsApi extends BaseAPI {
     ...
     * @throws {RequiredError}
     */
    public resultsBestGet(by: ResultsBestGetByEnum, options?: RawAxiosRequestConfig) {
        return ResultsApiFp(this.configuration).resultsBestGet(by, options).then((request) => request(this.axios, this.basePath));
    }
...
export const ResultsBestGetByEnum = {
    Cpm: 'cpm',
    Wpm: 'wpm',
} as const;
export type ResultsBestGetByEnum = typeof ResultsBestGetByEnum[keyof typeof ResultsBestGetByEnum];
